...
function MainSection({
  ...
  return (
    <>  
    <div className={lightBg ? 'home__main-section': 'home--main-section darkBg'}>
      <div className='container'>
        <div className='row home--main-row'
        style={{display: 'flex', flexdirectoion: imgStart=== 'start' ? 'row-reverse':'row'}} >
          <div className='col'>
            <div className='home__main-text-wrapper'>
              ...
              <Link to='sign-up'>
                <Button className='nas' buttonSize='btn--wide' buttonColor='blue' >
                  {buttonLabel}
                </Button>
              </Link>
